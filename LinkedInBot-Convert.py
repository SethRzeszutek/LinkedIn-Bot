...
def Menu():
	...
	global NUM_LAZY_LOAD_ON_MY_NETWORK_PAGE
	...
	while True:
		try:
			...
			if response == 1:
				...
				elif settingChoice == 'NUM_LAZY_LOAD_ON_MY_NETWORK_PAGE':
					print("\t\tNUM_LAZY_LOAD_ON_MY_NETWORK_PAGE:"+str(NUM_LAZY_LOAD_ON_MY_NETWORK_PAGE))
					print("\t\tHow many times it will scroll? Recommend to keep this around 10-15.")
					NUM_LAZY_LOAD_ON_MY_NETWORK_PAGE = int(input('\t\t> '))
